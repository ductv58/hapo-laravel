...
Route::group(['prefix'=>'teacher','namespace' => 'Teacher'], function (){
    ...
    Route::get('register_course', 'CourseController@getRegister')->name('teacher.course.get_register')->middleware('teacher');
    Route::post('register_course', 'CourseController@postRegister')->name('teacher.course.post_register')->middleware('teacher');
    Route::get('list_course', 'CourseController@getList')->name('teacher.course.get_list')->middleware('teacher');
    Route::post('delete/{id}', 'CourseController@delete')->name('teacher.course.delete')->middleware('teacher');
    Route::get('add_point/{id}', 'CourseController@getAddPoint')->name('teacher.course.get_add_point')->middleware('teacher');
    Route::post('add_point/{id}', 'CourseController@postAddPoint')->name('teacher.course.post_add_point')->middleware('teacher');
...
Route::group(['prefix'=>'student','namespace' => 'Student'], function (){
    ...
    Route::get('register_course', 'CourseController@getRegister')->name('student.course.get_register')->middleware('student');
    Route::post('register_course', 'CourseController@postRegister')->name('student.course.post_register')->middleware('student');
    Route::get('list_course', 'CourseController@getList')->name('student.course.get_list')->middleware('student');
